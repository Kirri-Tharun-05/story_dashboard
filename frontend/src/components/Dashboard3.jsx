...
// import './Dashboard.css'; // make sure to create a CSS file if not using styled-components
    ...
    <div className='tabs'>
      ...
      <div className='tab2'>
        <div className='chat'>
          {loading ? (
            ...
            <p className='empty-text'>Type an author's name to see stories!</p>
          )}
        </div>
      ...
      {isSidebarOpen && (
        <div className='sidebar'>
          ...
          <iframe src={previewUrl} title="Story Preview" frameBorder="0" className='iframe-preview'></iframe>
        </div>
      )}
    </div>
  );
